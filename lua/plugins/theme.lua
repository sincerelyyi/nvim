return {
    -- 以广受欢迎的 tokyonight 主题为例
    {
        ...
        opts = {
            style = "moon", -- 主题风格: "storm", "moon", "night", "day"
        ...
        config = function(_, opts)
            ...
            vim.api.nvim_set_hl(0, "LineNr", { bg = "#7a0f70" }) -- 行号背景
            vim.api.nvim_set_hl(0, "CursorLine", { bg = "#2c2c3a" }) -- 光标行背景
            vim.api.nvim_set_hl(0, "SignColumn", { bg = "none" }) -- 符号列透明
        end,
    },
}
